...
<div class="layout">
  ...
  <div class="brand">CrushV<span>Cult</span></div>
  ...
  <a routerLink="/ask-ai" routerLinkActive="active">Ask AI</a>
  <a routerLink="/cart" routerLinkActive="active">Cart</a>
</nav>

<<<<<<< Updated upstream:node_modules/@schematics/angular/application/files/common-files/src/app/app__suffix__.html.template
<style>
  :host {
...
>>>>>>> Stashed changes:src/app/app.html
